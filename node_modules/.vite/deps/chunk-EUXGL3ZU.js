...
var ListItem = React22.forwardRef(function ListItem2(inProps, ref) {
  ...
  const {
    ...
    slotProps = {},
    slots = {}
  } = props, ContainerProps = _objectWithoutPropertiesLoose(props.ContainerProps, _excluded18), other = _objectWithoutPropertiesLoose(props, _excluded22);
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime23.jsx)(ListContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime24.jsxs)(ListItemContainer, _extends({
        ...
        children: [(0, import_jsx_runtime23.jsx)(Root, _extends({}, rootProps, !isHostComponent_default(Root) && {
          as: Component,
...
var Tab = React34.forwardRef(function Tab2(inProps, ref) {
  ...
  const icon = iconProp && label && React34.isValidElement(iconProp) ? React34.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime40.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime40.jsxs)(React34.Fragment, {
      children: [icon, label]
...
//# sourceMappingURL=chunk-EUXGL3ZU.js.map
