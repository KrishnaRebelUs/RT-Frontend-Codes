...
//       const sortedYears = yearsWithData.sort((a, b) => parseInt(b) - parseInt(a));
...
//       ${new Intl.NumberFormat(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(parseFloat(yearlyData[getTopThreeYears()[0]] || 0))}
...
//               <TypographyStyled variant="h6" mb={1}>
//                 {year}
//               </TypographyStyled>
//               <Typography variant="h6">
//                 <b>${new Intl.NumberFormat(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(parseFloat(yearlyData[year] || 0))}</b>
//               </Typography>
//             </Grid>
//           ))}
//       </Grid>
...
//                     <Typography variant="h6">
//                       ${new Intl.NumberFormat(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(parseFloat(yearlyData[year] || 0))}
//                     </Typography>
//                   </CustomStack>
//                 ))}
//             </Grid>
...
const YearlyTrend = () => {
  ...
  const TypographyStyled = styled(Typography)(({ theme, index }) => ({
    color: index % 3 === 0 ? "#2edd95" : index % 3 === 1 ? "#f89c53" : "#285a9e",
  }));
  ...
  return (
    ...
    >
      ...
      <TypographyStyled variant="h6" index={0} sx={{ color: "#2edd95" }}>
        {getTopThreeYears()[0]}
      </TypographyStyled>
              ...
              {Object.keys(yearlyData)
                ...
                .map((year, index) => (
                  <CustomStack
                    ...
                    justifyContent="space-between"
                  >
                    <TypographyStyled variant="h6" index={index}>
                      {year}
                    </TypographyStyled>
                    <Typography variant="h6">
                      ${new Intl.NumberFormat(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(parseFloat(yearlyData[year] || 0))}
