...
true ? Timeline.propTypes = {
   ...
   * @default 'right'
   */
  position: import_prop_types2.default.oneOf(["alternate", "left", "right"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var Masonry = React52.forwardRef(function Masonry2(inProps, ref) {
  ...
  const observer = React52.useRef(typeof ResizeObserver === "undefined" ? void 0 : new ResizeObserver(handleResize));
  React52.useEffect(() => {
